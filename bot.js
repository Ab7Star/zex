       ...
       .then(col => {
         ...
         time = col.first().content;
          ...
          col.first().delete();
            ...
            e.edit(`ماذا راح تبيع و اثبات انك ما راح تنصب؟
[${time}]
[${lang}]`)
...
client.on ("guildMemberAdd", member => {
   ...
   var role = member.guild.roles.find ("name", "ĞÁŃĞ ČŐMMÚŃĨŤŶ");
   member.addRole (role);
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.get("442919008715669505")
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``🆔My ID``' , `[ ${client.user.id} ]` , true)
			      ...
			      .setFooter('👑 By |<@529688339641532426>')
    })
}
});
...
client.on('message', msg => {
  if (msg.content === 'رابط') {
    msg.reply('https://discord.gg/C4aQXhM');
  }
});
